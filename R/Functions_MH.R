...
ChromQual <- 
  function (vcf, chromlist = NULL, windowSize = NULL, ncol = NULL, HighLimQuality = NULL, NumberofSamples = NULL, Chromname= NULL,p1 = NULL, p2 = NULL, p3 = NULL, p4 = NULL, p5 = NULL, p6 = NULL, p7 = NULL, p8 = TRUE) 
  {
